...
// Test: passed
// Command: 
//  nextflow src/processes/scanpy/batch_effect_correct.test.nf --tenx_folder data/01.count/**/filtered_feature_bc_matrix --project_name tiny -resume
//
...
workflow test( f ) {
    main:
        ...
        SC__SCANPY__BATCH_EFFECT_CORRECTION( SC__FILE_CONVERTER.out )
    emit:
