...
workflow nemesh {
    ...
    */
    ...
    if (params.tools.nemesh.custom_selected_barcodes) {
        Channel
            .fromPath(params.tools.nemesh.custom_selected_barcodes)
            .map {
                path -> tuple(path.baseName.split('\\.')[0], params.tools.nemesh.custom_selected_barcodes, path)
            }
